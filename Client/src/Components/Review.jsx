    ...
    <div>
      ...
      >
        {reviewData.map((review, idx) => (
          <div key={idx}>
            <SwiperSlide>
              <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 dark:divide-gray-300 bg-gray-900 dark:bg-gray-100 text-gray-100 dark:text-gray-800 h-[300px]">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-gray-400 dark:text-gray-600">
                        {review.posted_days_ago} days ago
                      </span>
                    </div>
                  </div>
